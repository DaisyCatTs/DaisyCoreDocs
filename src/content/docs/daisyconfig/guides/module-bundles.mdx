...
If you want the exact Phase 3 shape in one place, use the [Example Plugin Walkthrough](/daisyconfig/guides/example-plugin-walkthrough/). It mirrors the current DaisyConfig example plugin instead of introducing a second docs-only layout.
