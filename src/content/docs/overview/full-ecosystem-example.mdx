...
## 2. Managed config ownership with DaisyConfig
...
Managed files are the preferred path once config lifecycle and reload safety are real plugin concerns.
...
- Follow the intended stack path: [Build the Normal Stack](/overview/build-the-normal-stack/)
