          ...
          items: [
            ...
            },
            {
              ...
              items: [
                ...
                { label: 'Villager Professions', slug: 'daisyseries/modules/villager-professions' },
                { label: 'Attributes', slug: 'daisyseries/modules/attributes' },
                { label: 'Entity Types', slug: 'daisyseries/modules/entities' },
                { label: 'Game Modes', slug: 'daisyseries/modules/game-modes' },
                { label: 'Difficulties', slug: 'daisyseries/modules/difficulties' },
                { label: 'Block Faces', slug: 'daisyseries/modules/block-faces' },
                { label: 'Damage Causes', slug: 'daisyseries/modules/damage-causes' },
                { label: 'Operations', slug: 'daisyseries/modules/operations' },
                { label: 'Pattern Types', slug: 'daisyseries/modules/pattern-types' },
            ...
            },
            {
              ...
              items: [
                ...
                { label: 'Villager Professions', slug: 'daisyseries/dictionary/villager-professions' },
                { label: 'Attributes', slug: 'daisyseries/dictionary/attributes' },
                { label: 'Entity Types', slug: 'daisyseries/dictionary/entities' },
                { label: 'Game Modes', slug: 'daisyseries/dictionary/game-modes' },
                { label: 'Difficulties', slug: 'daisyseries/dictionary/difficulties' },
                { label: 'Block Faces', slug: 'daisyseries/dictionary/block-faces' },
                { label: 'Damage Causes', slug: 'daisyseries/dictionary/damage-causes' },
                { label: 'Operations', slug: 'daisyseries/dictionary/operations' },
                { label: 'Pattern Types', slug: 'daisyseries/dictionary/pattern-types' },
            ...
            },
            {
              ...
              items: [
                ...
                { label: 'Villager Profession API', slug: 'daisyseries/reference/villager-profession-api' },
                { label: 'Attribute API', slug: 'daisyseries/reference/attribute-api' },
                { label: 'Entity API', slug: 'daisyseries/reference/entity-api' },
                { label: 'Game Mode API', slug: 'daisyseries/reference/game-mode-api' },
                { label: 'Difficulty API', slug: 'daisyseries/reference/difficulty-api' },
                { label: 'Block Face API', slug: 'daisyseries/reference/block-face-api' },
                { label: 'Damage Cause API', slug: 'daisyseries/reference/damage-cause-api' },
                { label: 'Operation API', slug: 'daisyseries/reference/operation-api' },
                { label: 'Pattern Type API', slug: 'daisyseries/reference/pattern-type-api' },
